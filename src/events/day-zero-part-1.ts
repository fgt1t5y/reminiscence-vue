...
dayZero.lang({
  en_US: {
    "event.dayZero.1":
      "Finally I have a bakery of my own, I'm kind of nervous to run a business on my own.",
    "event.dayZero.2":
      "Tomorrow is the opening day, I should make some bread now.",
    "event.dayZero.3":
      "Just make some white bread for now, tomorrow I will see what my customers want.",
    "event.dayZero.4": 'Click the bread in "Recipes" and make some bread!',
    "event.dayZero.5":
      "You need at least 10 White Bread for proceeding to next day.",
  },
  zh_CN: {
...
dayZero.dialog(
  "character.ramii.name",
  "event.dayZero.1",
  characters.ramii.icon
);
dayZero.dialog(
  "character.ramii.name",
  "event.dayZero.2",
